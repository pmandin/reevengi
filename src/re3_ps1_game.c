...
static int re3ps1game_getNumCamswitches(room_t *this);
static void re3ps1game_getCamswitch(room_t *this, int num_camswitch, room_camswitch_t *room_camswitch);
...
static int re3ps1game_loadroom_ard(const char *filename)
{
	...
	game_state.room->num_camswitches = re3ps1game_getNumCamswitches(game_state.room);

	game_state.room->getCamera = re3ps1game_getCamera;
	game_state.room->getCamswitch = re3ps1game_getCamswitch;
