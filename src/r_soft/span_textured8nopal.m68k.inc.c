...
__asm__ __volatile__ (
	...
	/* Pixels 0,1 */
	"fmove.s	fp1," ASM_v1 "\n\t"	/* v1 = v2, 2 cycles */
	"moveb	" ASM_texpixels1 "@(0,d4:w),d2\n\t"
	"movel	" ASM_uv ",d0\n\t"
	...
	"fmove.s	fp2," ASM_w1 "\n\t"	/* w1 = w2, 2 cycles */
	"moveb	" ASM_texpixels1 "@(0,d0:w),d2\n\t"
	"lsrw	" ASM_vbits1 ",d4\n\t"
