...
static void re2ps1_getCamera(room_t *this, int num_camera, room_camera_t *room_camera);

static int re2ps1_getNumCamswitches(room_t *this);
static void re2ps1_getCamswitch(room_t *this, int num_camswitch, room_camswitch_t *room_camswitch);
...
static int re2ps1_loadroom_rdt(const char *filename)
{
	...
	game_state.room->num_camswitches = re2ps1_getNumCamswitches(game_state.room);

	game_state.room->getCamera = re2ps1_getCamera;
	game_state.room->getCamswitch = re2ps1_getCamswitch;
