...
"""
Name: 'Resident Evil PLD/PLW...'
Blender: 241
Group: 'Import'
Tip: 'Import a Resident Evil PLD/PLW file'
"""

__author__ = "Patrice Mandin"
__version__ = "0.1"
__bpydoc__ = """\
This script imports Resident Evil PLD/PLW files into Blender.
No normals support.
No texture support.

Usage:

Run this script from "File->Import" and select the desired PLD/PLW file.
"""

# Copyright (C) 2008: Patrice Mandin, pmandin@caramail.com
...
#	texture_read(filename[:-4] + ".tim")
	...
	try:
		...
		# Seek to dir object 1
 		file.seek(dir_offset + 4*1)
...
Blender.Window.FileSelector(filesel_callback, "Import PLD/PLW")
